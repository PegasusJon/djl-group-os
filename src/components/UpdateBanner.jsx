...
export default function UpdateBanner() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 px-4 py-3 rounded-xl border border-brand-600/50 bg-brand-600/20 shadow-2xl text-sm text-slate-200 backdrop-blur-sm">
      {status === 'available' ? (
        <>
